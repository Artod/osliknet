System.register(['angular2/core', 'angular2/router', '../services/message/message.service', '../services/notification/notification.service', './user-card.component', '../pipes/to-date.pipe'], function(exports_1) {
